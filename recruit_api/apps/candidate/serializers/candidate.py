...
class CandidateListSerializer(serializers.ModelSerializer):
    ...
    def get_bill_rate_cal(self, candidate):
        if candidate.status_visa==6:
            return candidate.job.third_party_bill_rate
        elif candidate.status_visa==5:
            return candidate.job.visa_1099_bill_rate
        elif candidate.status_visa==2:
            return candidate.job.citizen_bill_rate
        elif candidate.status_visa==3:
            return candidate.job.green_card_bill_rate
        else:
            return 0
    ...
    def get_job_citizen_bill_rate(self, candidate):
        if candidate.job:
            title = candidate.job.citizen_bill_rate
            return title
        else:
            return ''
    ...
    def get_job_green_card_bill_rate(self, candidate):
        if candidate.job:
            title = candidate.job.green_card_bill_rate
            return title
        else:
            return ''
    ...
    def get_job_third_party_bill_rate(self, candidate):
        if candidate.job:
            title = candidate.job.third_party_bill_rate
            return title
        else:
            return ''
    ...
    def get_job_visa_1099_bill_rate(self, candidate):
        if candidate.job:
            title = candidate.job.visa_1099_bill_rate
            return title
        else:
            return ''
    ...
    class Meta:
        ...
        fields = ("id", "phone", "email", "created", "name", "company", "role", "industry","modified",
                  ...
                  "status_display", "job_title", "client_name", "recruiter_name", "send_signature_html", "fee",
                  ...
                  "third_party_id", "resume_url","job_citizen_bill_rate","job_green_card_bill_rate", "pay_rate","job_third_party_bill_rate","job_visa_1099_bill_rate","weekly_total_hours","bill_rate_manula","bill_rate")
